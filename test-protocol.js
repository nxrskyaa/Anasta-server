...
room.handleMessage("p3", cara, { t: "boss_hit", bossId: room.boss.id, damage: 20 }, start + 4001);
assert.equal(room.boss.hp, 30, "a second contributor shares the same HP pool");
room.handleMessage("p2", bob, { t: "boss_hit", bossId: room.boss.id, damage: 30 }, start + 4002);
